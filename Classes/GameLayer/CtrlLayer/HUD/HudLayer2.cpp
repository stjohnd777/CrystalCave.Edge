...
HudLayer2* HudLayer2::create()
{
    HudLayer2 *pRet = new(std::nothrow) HudLayer2();
    if (pRet && pRet->init()) {
        pRet->autorelease();
    }else{
        delete pRet;
...
void HudLayer2::startTracking(){
    stopTracking();
    scheduleUpdate();
}

void HudLayer2::stopTracking(){
    unscheduleAllSelectors();
}

void HudLayer2::setHiScore(int score){
...
void HudLayer2::setHiLevel(int level){
...
void HudLayer2::setScore(int value){
...
void HudLayer2::setLevel(int currentLevel){
...
void HudLayer2::setPlayTime(long mill){
...
void HudLayer2::setHealth(int health){
...
void HudLayer2::update(float dt){
...
//Label * pausedlabel ;
void HudLayer2::menuPauseCallback(Ref* pSender)
{
    static bool action = true;
    if ( action)
    {
