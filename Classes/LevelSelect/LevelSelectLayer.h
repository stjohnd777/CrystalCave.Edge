    ...
    bool init(){
        ...
        for ( int row = 0 ; row < y ; row ++){
            ...
            for ( int col = 1 ; col < x ; col ++){
                ...
                stringstream ss;
                ss << level << " " <<  "Level Name" <<   std::endl << "Deccription hq   db  qhdh    qd  " <<"\n"<< "Score : 10000" <<   std::endl;
                ...
                if ( isLevelOpen) {
                    ...
                    star1->setPosition( Vec2(startSize.width/2, startSize.height/2 ) );
                    auto star2 = Sprite::create(GameAssets::Sprite::STAR_ON);
                    star2->setPosition( Vec2( startSize.width + startSize.width/2, startSize.height/2 ) );
                    auto star3 = Sprite::create(GameAssets::Sprite::STAR_OFF);
                    star3->setPosition( Vec2(2* startSize.width +startSize.width/2, startSize.height/2 ) );
